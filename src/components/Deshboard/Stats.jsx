const Stats = ({
    ...
    const icons = {
        Total_Views: <span class="inline-block h-7 w-7 rounded-full bg-[#E4D3FF] p-1 text-[#ae7aff]">
        <svg
      ...
      Total_Subscribers:<span class="inline-block h-7 w-7 rounded-full bg-[#E4D3FF] p-1 text-[#ae7aff]">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
    ...
    Total_Likes: <span class="inline-block h-7 w-7 rounded-full bg-[#E4D3FF] p-1 text-[#ae7aff]">
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
      viewBox="0 0 24 24"
    ...
    return (
        ...
        <div class="mb-4 block">
          {icons[name.replace(" ","_")]}
        </div>
        <h6 class="text-gray-300">{name}</h6>
